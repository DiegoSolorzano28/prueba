...
package com.example.app_lenacarbon.databinding;
...
import com.example.app_lenacarbon.R;
...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnLogin,
      @NonNull Guideline guidelineMediumHorizonal, @NonNull ImageView imgLogo,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.guideline_medium_horizonal;
      Guideline guidelineMediumHorizonal = ViewBindings.findChildViewById(rootView, id);
      if (guidelineMediumHorizonal == null) {
        break missingId;
      }
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, btnLogin,
          guidelineMediumHorizonal, imgLogo, tilEmail, tilPassword);
    }
